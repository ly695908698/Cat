...
<body>
	<div style="margin-bottom:20px;margin-top:20px;margin-left: 200px;">
		<form action="addLeaveMessageAction" method="post"
			id="leaveMessageForm" onsubmit="return checkNull();">
			<span style="font: normal 0.80em arial, sans-serif;color:#666666;">留言者昵称：</span><input
				type="text" name="leaveMessage.leaveMessageName" maxlength="10" />
			<br /> <br />
			<textarea style="width:953px;height:100px;border:none;background:none ;"
				...
				class="word_count2" id="word_count">0</span> 字，限制500字内。
			</span>
			<br /><br /> <input type="submit" value="留言" id="leaveBtn" class="leaveBtn"
				name="isEmpty"
				style="font-family: Verdana, Arial, sans-serif;
						-webkit-border-radius: 4px;
border-radius: 4px;
display: inline-block;
background: #459300 url('back/resources/images/bg-button-green.gif') top left repeat-x !important;
...
cursor: pointer;" />
								...
								<div class="post_metadata">
									<div class="content">
										<span class="comment"><a href="#comments"
											style="text-decoration: none;"><s:property value="count" />条留言</a></span>
									</div>
								</div>
							</div>
							<div class="post">
												...
												<li class="alt">
													...
													<div class="comment_author left">
														<span class="comment"><s:property
																value="#leaveMessage.leaveMessageName" /></span>
														<div class="date">
															<a href="#"><s:date
																	name="#leaveMessage.leaveMessageDate"
																	format="yyyy-MM-dd HH:mm:ss" /></a> <span
																style="margin-left:700px;">#${floor-st.index}楼</span>
														</div>
													</div>
	...
	<div style="margin-left:500px;">
		...
		</span> 页 [ <a href="findLeaveMessageToFrontAction?pageNow=1"
